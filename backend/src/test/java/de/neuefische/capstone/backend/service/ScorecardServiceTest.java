...
class ScorecardServiceTest {
    ...
    void saveScorecard() {
        ...
        scorecardDTO.setScores(Collections.singletonList(new Score(1, 5, 2, true, 1, 1,1)));
        ...
        savedScorecard.setScores(Collections.singletonList(new Score(1, 5, 2, true, 1, 1, 1)));
