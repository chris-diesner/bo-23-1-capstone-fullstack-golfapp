                            ...
                            <div className="AppList">
                                ...
                                <div className="ButtonGroup">
                                    <div className="d-flex justify-content-between">
                                        <Button className="AppButton" variant="primary" onClick={onPrevHole}
                                                disabled={!hasPrevHole}>
                                            Previous Hole
                                        </Button>
                                        {isLastHole ? (
                                            <Button className="AppButton" variant="primary"
                                                    onClick={handleSaveAndScoreCard}>
                                                Save Scorecard
                                            </Button>
                                        ) : (
                                            <Button className="AppButton" variant="primary" onClick={onNextHoleAndSave}
